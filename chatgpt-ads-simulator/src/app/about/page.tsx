...
import { BOOK_DEMO_URL, FOUNDER } from "@/lib/marketing";
      ...
      <main className="mx-auto max-w-2xl px-6 py-14">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-zinc-600">
          ...
          <p>
            ...
            of why brands burn money on emerging ad channels before knowing what
            works. ChatGPT Ads launched in February and hit $100M ARR in six
            weeks. The brands using it are flying blind. We&apos;re building the
            optimization layer.
          </p>
          <p>
            We&apos;re in closed beta with design partners. Small team, direct
            support for every customer we onboard.
          </p>
        </div>
